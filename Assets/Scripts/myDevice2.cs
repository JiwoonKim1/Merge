...
public struct myDeviceState2 : IInputStateTypeInfo
{
...
[InputControlLayout(stateType = typeof(myDeviceState2))]
#if UNITY_EDITOR
[InitializeOnLoad] // Make sure static constructor is called during startup.
#endif
public class myDevice2 : InputDevice, IInputUpdateCallbackReceiver
{
    ...
    static myDevice2()
    {
        InputSystem.RegisterLayout<myDevice2>(
            ...
            .WithInterface("HID")
            .WithCapability("productId", 64)
            .WithCapability("vendorId", 10007));
    }
    ...
    public static myDevice2 current { get; private set; }

    public static IReadOnlyList<myDevice2> all => s_AllMyDevices;
    private static List<myDevice2> s_AllMyDevices = new List<myDevice2>();
