...
public class StripeUpdownCSV : MonoBehaviour
{
    ...
    private void setFilePath()
    {
        ...
        if (!Directory.Exists(dataPath + "/Stripe(updown)"))
            Directory.CreateDirectory(dataPath + "/Stripe(updown)");

        writer = new CsvFileWriter(dataPath + "/Stripe(updown)" + "/BlueTooth" + System.DateTime.Now.ToString("yyyyMMddHHmm") + ".csv");
    }
