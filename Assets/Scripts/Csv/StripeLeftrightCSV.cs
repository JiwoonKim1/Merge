...
public class StripeLeftrightCSV : MonoBehaviour
{
    ...
    private void setFilePath()
    {
        ...
        if (!Directory.Exists(dataPath + "/Stripe(leftright)"))
            Directory.CreateDirectory(dataPath + "/Stripe(leftright)");

        writer = new CsvFileWriter(dataPath + "/Stripe(leftright)" + "/BlueTooth" + System.DateTime.Now.ToString("yyyyMMddHHmm") + ".csv");
    }
