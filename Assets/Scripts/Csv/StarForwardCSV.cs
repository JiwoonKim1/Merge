...
public class StarForwardCSV : MonoBehaviour
{
    ...
    private void setFilePath()
    {
        ...
        if (!Directory.Exists(dataPath + "/Star(forward)"))
            Directory.CreateDirectory(dataPath + "/Star(forward)");

        writer = new CsvFileWriter(dataPath + "/Star(forward)" + "/BlueTooth" + System.DateTime.Now.ToString("yyyyMMddHHmm") + ".csv");
    }
