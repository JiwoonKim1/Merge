...
public class CubeForwardCSV : MonoBehaviour
{
    ...
    private void setFilePath()
    {
        ...
        if (!Directory.Exists(dataPath + "/Cube(forward)"))
            Directory.CreateDirectory(dataPath + "/Cube(forward)");

        writer = new CsvFileWriter(dataPath + "/Cube(forward)" + "/BlueTooth" + System.DateTime.Now.ToString("yyyyMMddHHmm") + ".csv");
    }
